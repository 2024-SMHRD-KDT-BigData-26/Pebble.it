<%@page import="com.Pebble.it.model.DiaryDTO"%>
<%@page import="java.util.List"%>
<%@page import="com.Pebble.it.model.DiaryDAO"%>
	...
	<div class="layout">
		...
		<div class="main-content">
			...
			<div class="diary-toolbar">
				<!-- 기록 등록 버튼 -->
				<a href="diary_post.jsp"><button id="diary_post_btn"
						class="diary_post_btn">+ 기록 등록</button></a>
				<!-- 카테고리 선택 -->
				...
				<div class="diary-content">
					...
					<a href="#"><table width="100%" class="diary_content_list">						
							<tr>
								...
								<td rowspan="3"><img
									src="resources/img/diary_sample_img.png" id="diary_img"></td>
							</tr>
							<tr>
							...
							<tr>
								<td>
								배영은 물 위에 등을 대고 누운 자세로 물을 가르는 수영 방식입니다. <br> 초보자에게
									적합한 이유는 호흡이 자유롭고 비교적 배우기 쉽기 때문입니다. <br> 기본 자세는 몸을 최대한 곧게
									펴고, 배꼽이 물 밖으로 나오도록 몸을 띄우는 것입니다.
								</td>
							</tr>
						</table></a> <a href="#"><table width="100%" class="diary_content_list">
							<tr>
							...
							<tr>
								<td>배영은 물 위에 등을 대고 누운 자세로 물을 가르는 수영 방식입니다. <br> 초보자에게
									적합한 이유는 호흡이 자유롭고 비교적 배우기 쉽기 때문입니다. <br> 기본 자세는 몸을 최대한 곧게
									펴고, 배꼽이 물 밖으로 나오도록 몸을 띄우는 것입니다.
								</td>
							</tr>
