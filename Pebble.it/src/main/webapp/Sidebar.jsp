...
<%@ page import="com.Pebble.it.model.MemberDAO"%>
...
<body>
	...
	<div class="left-sidebar">
		<img src="resources/img/home_logo.png" alt="페블잇 로고"
			id="pebble_it_menu_logo">
		<div id="my_info">
			<table id="info_output">
				<tr>
					<td id="profile_td"><img
						src="resources/img/no_profile_img.png" alt="프로필 이미지"
						id="profile_img"></td>
					<td>닉네임님<br>오늘도 할 수 있어요!
					</td>
				</tr>
				<tr>
					<td colspan="2">관심운동: 수영<br>포인트: 999,999P
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<div id="info_config" class="btn">
							<img src="resources/img/info_config_img.png">&nbsp;&nbsp;내정보 변경
						</div>
					</td>
				</tr>
			</table>
		...
		<nav class="sidebar-menu">
			<a href="home_content.html"><div id="menu_name" class="menu01">
				...
				</div></a> <a href="diary_list.html"><div id="menu_name">
		...
		<form action="" method="post" enctype="multipart/form-data">
			<div id="todo_post_modal" class="modal-content_config">
				<table class="modal_table">
					<tr class="tr_line">
						<td>내 정보 변경
							<button id="resign" class="btn">회원 탈퇴</button> 
					...
					<tr>
						<td>
							...
							<div class="profile_img">
								<label for="profile-upload">프로필 사진 선택</label> <input
									id="profile-upload" name="profileImg" type="file"
									accept="image/*" style="display: none;" /> <img
									id="profile-preview" src="#" alt="미리보기"
									style="display: none; width: 150px; height: 150px; margin-top: 10px;" />
							</div>

							<div class="my_id">ID: smilecat</div> <!-- 닉네임 입력 -->
							<div class="Join">
								<input type="text" name="name" id="nickname"
									placeholder="닉네임 (1~8자 영문, 한글, 숫자)" required>
								<button type="button" id="check-nick" class="check-btn">중복확인</button>
								<small id="nick-error" class="error-message"></small>
							</div> <!-- 기존 비밀번호 입력 -->
							<div class="Join">
								<input type="password" name="pw" id="old_password"
									class="password" placeholder="기존 비밀번호 입력 (8~16자의 영문 대/소문자, 숫자)"
							...
							<div class="Join">
								<input type="password" name="pw" id="new_password"
									class="password" placeholder="새 비밀번호 입력 (8~16자의 영문 대/소문자, 숫자)"
									required pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,16}$"
									title="비밀번호는 8~16자 사이의 영문(대/소문자)과 숫자를 포함해야 합니다."> <small
									id="password-error" class="error-message"></small>
							</div> <!-- 관심 운동 선택 -->
							<div class="sport_check">
								...
								<label><input type="radio" name="favoriteSport"
									value="헬스" required> 헬스</label> <label><input
									type="radio" name="favoriteSport" value="수영" required>
									수영</label> <label><input type="radio" name="favoriteSport"
									value="테니스" required> 테니스</label>
							</div> <!-- 운동 수준 선택 -->
							<div class="sport_check">
								<p class="sport_text">| 나의 운동 수준 (택1)</p>
								<label><input type="radio" name="sportLevel"
									value="lev1" required> 초급자</label> <label><input
									type="radio" name="sportLevel" value="lev2" required>
									중급자</label> <label><input type="radio" name="sportLevel"
									value="lev3" required> 전문가</label>
							</div> <!-- 메시지 영역 -->
	...
	<div id="modalContainer" class="modal">
		<!-- 회원 삭제 모달 내용 -->
		<div id="user_delete_modal" class="modal-content">
			<table class="modal_table">
				<tr class="tr_line">
					<td>회원 탈퇴 
					<!-- 모달 내에서 취소 버튼이 1개밖에 동작하지 않아 일단 주석처리 -->
				...
				<tr>
					<td id="delete_msg">탈퇴 시 이용내역은 복구할 수 없습니다.<br> 탈퇴하시겠습니까?
					</td>
				</tr>
				<tr>
					<td>
